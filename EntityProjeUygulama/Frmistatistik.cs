...
namespace EntityProjeUygulama
{
    public partial class Frmistatistik : Form
    {
        ...
        private void Frmistatistik_Load(object sender, EventArgs e)
        {
            ...
            label17.Text = db.TBLURUN.Count(x => x.URUNAD == "Laptop").ToString();
            label23.Text = (from x in db.TBLMUSTERI select x.SEHIR).Distinct().Count().ToString(); //Distinct Count tekrarsız olarak sayma
